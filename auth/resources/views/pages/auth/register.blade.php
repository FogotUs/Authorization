...
<header class="flex items-center justify-between p-6">
    ...
    <div>
        <a href="{{route('main')}}" class="rounded-md bg-gray-200 py-2 px-4 font-semibold text-gray-900 shadow-lg transition duration-150 ease-in-out hover:bg-gray-300 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2">Главная</a>
        <a href="{{route('login')}}" class="rounded-md bg-green-600 py-2 px-4 font-semibold text-white shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Вход</a>
    </div>
</header>
        ...
        <form action="{{route('register')}}" method="post" novalidate autocomplete="off">
            ...
            <div class="mb-6">
                ...
                <div class="relative mt-1 rounded-md shadow-sm">
                    ...
                    <input type="text" id="name" name="name" value="{{old('name')}}" required class="w-full rounded-md pl-10 text-sm border-gray-300 focus:border-green-500 focus:ring-green-500 {{$errors->has('name') ? 'text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 border-red-300' : 'border-gray-300 focus:border-green-500 focus:ring-green-500 placeholder:text-gray-400'}}" placeholder="John Doe" />
                    @error('name')
            ...
            <div class="mb-6">
                ...
                <div class="relative mt-1 rounded-md shadow-sm">
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation" required class="w-full rounded-md pl-10 text-sm border-gray-300 focus:border-green-500 focus:ring-green-500 {{$errors->has('password_confirmation') ? 'text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 border-red-300' : 'border-gray-300 focus:border-green-500 focus:ring-green-500 placeholder:text-gray-400'}}" placeholder="Minimum 8 characters" />
